      ...
      <div className="container px-5 py-24 mx-auto flex flex-wrap items-center">
        <div className="lg:w-3/5 md:w-1/2 md:pr-16 lg:pr-0 pr-0">
          ...
          <p className="leading-relaxed mt-4">
            Provide your learning details to access student resources.
          </p>
        </div>
        <form
        ...
        >
          ...
          <button
            className="text-white bg-green-600 border-0 py-2 px-8 focus:outline-none hover:bg-green-700 rounded text-lg"
            disabled={btnLoading}
          >
